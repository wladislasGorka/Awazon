...
>>>>>>> bfea1609030764b01b9ffcdec3a5b9d6a1204309
                    </v-card-text>
                </v-card>
            </v-col>
            <v-col cols="12" sm="6" md="4">
                <v-card>
                    ...
                    <v-card-text>
                        <RouterLink :to="`/dashboard/${userID}/products`"><v-btn>Gestion des produits</v-btn></RouterLink>
                    </v-card-text>
                </v-card>
            </v-col>
            <v-col cols="12" sm="6" md="4">
                <v-card>
                    <v-card-title>Evenements</v-card-title>
                    <v-card-text>
                        <v-btn>Gestion des événements</v-btn>
                    </v-card-text>
                </v-card>
            </v-col>
            <v-col cols="12" sm="6" md="4">
                <v-card>
                    ...
                    <v-card-text>
                        <v-btn>Gestion des promotions</v-btn>
                    </v-card-text>
                </v-card>
            </v-col>
            <v-col cols="12" sm="6" md="4">
            ...
            <v-col cols="12" sm="6" md="4">
                <v-card>
                    ...
                    <v-card-text>
                        <v-btn>Voir les statistiques</v-btn>
                    </v-card-text>
                </v-card>
            </v-col>
        </v-row>

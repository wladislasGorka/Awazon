...
/**
 * @extends PersistentProxyObjectFactory<SuperAdmin>
 */
final class SuperAdminFactory extends PersistentProxyObjectFactory
{
    /**
    ...
    {
        return $this
            // ->afterInstantiate(function(SuperAdmin $superAdmin): void {})
        ;
    }
}
